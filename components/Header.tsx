                                    ...
                                    <div className="relative group">
                                        ...
                                        <div className="absolute end-0 mt-2 w-56 bg-white rounded-xl shadow-lg py-2 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 -translate-y-2">
                                             ...
                                             <div className="py-1">
                                                ...
                                                <button onClick={() => onNavigate(Page.SavedListings)} className="w-full flex items-center gap-3 text-right px-4 py-2 text-sm text-slate-700 hover:bg-purple-50 hover:text-purple-700 transition"><BookmarkIcon className="w-5 h-5 text-slate-500"/>العروض المحفوظة</button>
                        ...
                        <>
                         ...
                         <nav className="flex-grow space-y-1">
                            ...
                            {publishedPages.map(page => (
                             ...
                             <button onClick={() => onNavigate(Page.SavedListings)} className="w-full flex items-center gap-4 px-4 py-3 text-slate-700 hover:bg-purple-50 rounded-lg transition"><BookmarkIcon className="w-6 h-6"/><span className="font-semibold">العروض المحفوظة</span></button>
...
const BookmarkIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.5 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0z" /></svg>);
